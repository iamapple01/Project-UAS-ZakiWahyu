...
import com.example.projectuas.databinding.ItemDateBinding
import com.example.projectuas.databinding.ItemTimeBinding
    ...
    inner class TimeViewholder (private val binding: ItemDateBinding):
        ...
        fun bind(date: String) {
            ...
            if(dateParts.size==3) {
                ...
                binding.datMonthTxt.text = date[1] + " " + dateParts[2]
